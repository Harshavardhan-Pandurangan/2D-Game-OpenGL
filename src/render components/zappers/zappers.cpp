...
void initZappers(){
    ...
    createShader("/Users/harshavardhan/Documents/CG/Assignment 1/2D Game/src/shaders/vertex.shader.2",
    "/Users/harshavardhan/Documents/CG/Assignment 1/2D Game/src/shaders/fragment.shader.2",
    &zapper_shader);
    ...
    unsigned char *data = stbi_load("/Users/harshavardhan/Documents/CG/Assignment 1/2D Game/src/render components/zappers/Zapper Final.png", &width, &height, &nrChannels, 0);
    ...
    data = stbi_load("/Users/harshavardhan/Documents/CG/Assignment 1/2D Game/src/render components/zappers/Zapper Diag 2.png", &width, &height, &nrChannels, 0);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, data);
    glGenerateMipmap(GL_TEXTURE_2D);
...
void renderZappers(){
    ...
    float curr_time_zappers = glfwGetTime() * 0.5f / 0.9f;
